...
- `read` tool calls against any `SKILL.md` file (workspace `.opencode/skills/`, user-level `~/.config/opencode/skills/`, or synced pstack paths under `~/.config/opencode/skills/`)
