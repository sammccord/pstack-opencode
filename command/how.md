...
argument-hint: "[critique] <subsystem or question>"
---

# How

Load the `how` skill with `skill({ name: "how" })` and execute it.
...
Follow the `how` skill exactly as written. Do not improvise around its steps or
...
- `/why` for motivation and history
