...
argument-hint: "[what to be blunt about]"
---

# Bro

Load the `bro` skill with `skill({ name: "bro" })` and execute it.
...
Follow the `bro` skill exactly as written. Do not improvise around its steps or
