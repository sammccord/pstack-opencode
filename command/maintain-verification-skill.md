...
argument-hint: "[verification skill name]"
---

# Maintain Verification Skill

Load the `maintain-verification-skill` skill with `skill({ name: "maintain-verification-skill" })` and execute it.
...
Follow the `maintain-verification-skill` skill exactly as written. Do not improvise around its steps or
