...
argument-hint: "<change or component to design>"
---

# Architect

Load the `architect` skill with `skill({ name: "architect" })` and execute it.
...
Follow the `architect` skill exactly as written. Do not improvise around its steps or
...
- `/interrogate` to stress-test the chosen design
- `/arena` for a head-to-head bakeoff
