...
argument-hint: "[scope or time window]"
---

# Reflect

Load the `reflect` skill with `skill({ name: "reflect" })` and execute it.
...
Follow the `reflect` skill exactly as written. Do not improvise around its steps or
...
- `/automate-me` to encode what you found
- `/create-verification-skill` if proof was the gap
