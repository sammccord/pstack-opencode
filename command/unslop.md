...
argument-hint: "<prose to clean>"
---

# Unslop

Load the `unslop` skill with `skill({ name: "unslop" })` and execute it.
...
Follow the `unslop` skill exactly as written. Do not improvise around its steps or
...
- `/technical-writing` for structure
