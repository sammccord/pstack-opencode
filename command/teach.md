...
argument-hint: "<concept, subsystem, or skill to learn>"
---

# Teach

Load the `teach` skill with `skill({ name: "teach" })` and execute it.
...
Follow the `teach` skill exactly as written. Do not improvise around its steps or
