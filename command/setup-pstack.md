...
Load the `setup-pstack` skill with `skill({ name: "setup-pstack" })` and execute it.
...
Follow the `setup-pstack` skill exactly as written. Do not improvise around its steps or
