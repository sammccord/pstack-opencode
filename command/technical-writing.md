...
argument-hint: "<doc, RFC, readme, PR description, or commit message>"
---

# Technical Writing

Load the `technical-writing` skill with `skill({ name: "technical-writing" })` and execute it.
...
Follow the `technical-writing` skill exactly as written. Do not improvise around its steps or
...
- `/unslop` to strip the slop
- `/deslopify` for a final naturalness pass
