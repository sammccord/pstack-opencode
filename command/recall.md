...
argument-hint: "<what to remember from earlier work>"
---

# Recall

Load the `recall` skill with `skill({ name: "recall" })` and execute it.
...
Follow the `recall` skill exactly as written. Do not improvise around its steps or
...
- `/reflect` to turn recalled patterns into structure
