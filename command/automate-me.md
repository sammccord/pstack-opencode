...
argument-hint: "[topic or behavior to capture]"
---

# Automate Me

Load the `automate-me` skill with `skill({ name: "automate-me" })` and execute it.
...
Follow the `automate-me` skill exactly as written. Do not improvise around its steps or
...
- `/reflect` to mine more patterns worth encoding
